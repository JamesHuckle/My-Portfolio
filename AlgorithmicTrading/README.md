...
## Learning curves
Training data is 2003-2016
Validation data is 2016-2018
...
## Results
An out of sample test dataset with data from 2019-2020 (not used during the validation proccess) is used to estimate out of sample variance. Estimates are represented as an equity curve.
### Best 7 models
